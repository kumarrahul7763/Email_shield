  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Total Emails */}
        <div className="stat-card bg-gradient-to-br from-purple-600 via-pink-600 to-purple-600">
        ...
        {/* High Priority */}
        <div className="stat-card bg-gradient-to-br from-red-600 via-rose-600 to-pink-600">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Spam Detected */}
        <div className="stat-card bg-gradient-to-br from-amber-600 via-orange-600 to-yellow-600">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Avg Confidence */}
        <div className="stat-card bg-gradient-to-br from-emerald-600 via-green-600 to-teal-600">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card-gradient">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-200">Category Distribution</h3>
                <p className="text-sm text-gray-400">Emails by category type</p>
              </div>
            </div>
            <div className="h-72">
          ...
          <div className="card-gradient">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-200">Priority Distribution</h3>
                <p className="text-sm text-gray-400">Emails by priority level</p>
              </div>
            </div>
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
      ...
      {stats.total === 0 && (
        <div className="card-gradient text-center py-16">
          <div className="w-28 h-28 mx-auto mb-6 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-purple-500/20 rounded-3xl flex items-center justify-center animate-float border border-purple-500/30">
            <svg className="w-14 h-14 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <h3 className="text-2xl font-bold text-gray-200 mb-3">No Data Yet</h3>
          <p className="text-gray-400 max-w-md mx-auto">Start by analyzing emails to see beautiful statistics and charts here</p>
        </div>
      )}
    </div>
  );
