      ...
      {backendStatus.checked && !backendStatus.running && (
        <div className="mb-6 p-4 bg-gradient-to-r from-red-500/10 to-rose-500/10 border-2 border-red-500/30 rounded-2xl backdrop-blur-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-red-300 mb-1">Backend Server Not Running</h3>
              <p className="text-sm text-red-400 mb-3">
                The backend server is not running. Please start it to enable email classification.
              </p>
              <div className="bg-white/5 rounded-lg p-3 text-xs font-mono text-red-300 border border-red-500/20">
