    ...
    return (
      <div className="card-gradient animate-fade-in">
        <div className="text-center py-8">
          <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-emerald-500/20 to-green-500/20 rounded-full flex items-center justify-center animate-bounce-subtle border border-emerald-500/30">
            <svg className="w-10 h-10 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <h3 className="text-2xl font-bold text-gray-200 mb-2">Thank you for your feedback!</h3>
          <p className="text-gray-400 mb-6">Your input helps us improve our classification accuracy.</p>
          <button
            onClick={handleReset}
  ...
  return (
    <div className="card-gradient animate-fade-in">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-200">Was this classification helpful?</h2>
          <p className="text-gray-400 mt-1">Help us improve by providing your feedback</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`
              ...
              ${feedback === 'helpful'
                ? 'border-emerald-500 bg-gradient-to-br from-emerald-500/10 to-green-500/10 shadow-lg shadow-emerald-500/20 scale-[1.02]'
                : 'border-white/10 hover:border-emerald-500/50 hover:bg-emerald-500/5'
              }
            `}
          >
            <span className="text-4xl">👍</span>
            <span className={`font-semibold ${feedback === 'helpful' ? 'text-emerald-400' : 'text-gray-300'}`}>
              Helpful
            </span>
            {feedback === 'helpful' && (
          ...
          <button
            ...
            className={`
              ...
              ${feedback === 'not-helpful'
                ? 'border-red-500 bg-gradient-to-br from-red-500/10 to-rose-500/10 shadow-lg shadow-red-500/20 scale-[1.02]'
                : 'border-white/10 hover:border-red-500/50 hover:bg-red-500/5'
              }
            `}
          >
            <span className="text-4xl">👎</span>
            <span className={`font-semibold ${feedback === 'not-helpful' ? 'text-red-400' : 'text-gray-300'}`}>
              Not Helpful
            </span>
            {feedback === 'not-helpful' && (
        ...
        {/* Comment textarea */}
        <div>
          <label htmlFor="feedback-comment" className="block text-sm font-semibold text-gray-300 mb-3">
      ...
      {/* Info box */}
      <div className="mt-6 p-4 bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-2xl border border-amber-500/20 backdrop-blur-sm">
