        ...
        <div className="animate-fade-in">
          {activeTab === 'classify' && (
            <div className="space-y-6 md:space-y-8">
              ...
              {/* Analyze Single Email - Top */}
              <EmailInput 
                onResult={handleSingleResult} 
                onError={handleError} 
              />
              
              {/* Bulk Email Upload - Middle */}
              <FileUpload 
                onResults={handleBulkResults} 
                onError={handleError} 
              />
              
              {/* Classification Results - Bottom */}
              {results.length > 0 ? (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-bold gradient-text">Mail-Shild</span>
              </div>
            ...
            {/* Categories */}
            <div>
              <h3 className="font-semibold text-lg mb-4 text-gray-200">Categories</h3>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-emerald-500/20 text-emerald-400 rounded-full text-sm border border-emerald-500/30">Finance</span>
                <span className="px-3 py-1.5 bg-blue-500/20 text-blue-400 rounded-full text-sm border border-blue-500/30">Technical</span>
                <span className="px-3 py-1.5 bg-red-500/20 text-red-400 rounded-full text-sm border border-red-500/30">Spam</span>
                <span className="px-3 py-1.5 bg-amber-500/20 text-amber-400 rounded-full text-sm border border-amber-500/30">Support</span>
                <span className="px-3 py-1.5 bg-purple-500/20 text-purple-400 rounded-full text-sm border border-purple-500/30">Promotional / Marketing</span>
              </div>
            </div>

            {/* Priority Levels */}
            <div>
              <h3 className="font-semibold text-lg mb-4 text-gray-200">Priority Levels</h3>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-red-500/20 text-red-400 rounded-full text-sm border border-red-500/30">High</span>
                <span className="px-3 py-1.5 bg-amber-500/20 text-amber-400 rounded-full text-sm border border-amber-500/30">Medium</span>
                <span className="px-3 py-1.5 bg-emerald-500/20 text-emerald-400 rounded-full text-sm border border-emerald-500/30">Low</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 md:mt-10 pt-6 md:pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm text-gray-400">
              ...
              <a
                href="mailto:contact@smartemailtriage.com"
                className="flex items-center gap-2 hover:text-purple-400 transition-colors duration-300"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
